...
@property(nonatomic, strong) UIColor *textHighlightedColor; // default is equal to textColor
@property(nonatomic, strong) UIColor *backgroundColor; // default is [UIColor whiteColor]
@property(nonatomic, strong) UIColor *selectionBackgroundColor; // default is [UIColor clearColor];
@property(nonatomic, strong) UIColor *selectionIndicatorColor;                     // default is [UIColor redColor]
