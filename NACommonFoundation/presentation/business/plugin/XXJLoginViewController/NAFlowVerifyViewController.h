...
@protocol XXJFlowVerifyDelegate <NSObject>

- (void)resendCode;

@end

@interface XXJFlowVerifyViewController : UIViewController <UITextFieldDelegate> {
...
@property(nonatomic, weak) id<XXJFlowVerifyDelegate> delegate;
/**
 *  必须重载用于验证验登录
 *
 */
