...
@interface NACheckBoxView (Private)
- (UIImage *)checkBoxImageForStyle:(NACheckBoxViewStyle)s
                           checked:(BOOL)isChecked;
- (CGRect)imageViewFrameForCheckBoxImage:(UIImage *)img;
- (void)updateCheckBoxImage;
@end

@implementation NACheckBoxView
...
- (id)initWithFrame:(CGRect)frame
  ...
  CGRect labelFrame =
      CGRectMake(32.0f, 7.0f, self.frame.size.width - 32, 20.0f);
  ...
  UIImage *img = [self checkBoxImageForStyle:_style checked:checked];
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
  ...
  if ([self superview]) {
    ...
    CGRect validTouchArea =
        CGRectMake((self.frame.origin.x - 5), (self.frame.origin.y - 10),
                   (self.frame.size.width + 5), (self.frame.size.height + 10));
...
- (UIImage *)checkBoxImageForStyle:(NACheckBoxViewStyle)s
  ...
  NSString *imageName = @"";
  switch (s) {
    case kNACheckBoxViewStyleBox:
      imageName = @"cb_box_";
      break;
    case kNACheckBoxViewStyleDark:
      imageName = @"cb_dark_";
      break;
    case kNACheckBoxViewStyleGlossy:
      imageName = @"cb_glossy_";
      break;
    case kNACheckBoxViewStyleGreen:
      imageName = @"cb_green_";
      break;
    case kNACheckBoxViewStyleMono:
      imageName = @"cb_mono_";
      break;
    default:
      return nil;
...
- (void)updateCheckBoxImage {
  checkBoxImageView.image = [self checkBoxImageForStyle:_style checked:checked];
}
